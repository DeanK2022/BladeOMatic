...
//https://randomnerdtutorials.com/esp32-pinout-reference-gpios/ - PINOUT REFERENCE
//SPI
...
#define TFT_RST   19 //22  // Reset pin (could connect to RST pin) external pull-up, low valid // External 10K pull-up resistor required, active - low reset
                                                                                          // https://www.distec.de/fileadmin/pdf/produkte/Touchcontroller/DDGroup/GT911_Datasheet.pdf
//#define TFT_Vcc "3.3v"
//#define TFT_GND "GND"
//#define LED "3.3v"
...
// Call pinMode(<PIN ID>, INPUT_PULLUP); 
//GPIO 21 (SDA)
//GPIO 22 (SCL)
//3.3V communication interface, 400Kbps, pull up resistor is 2K ohm

#define TOUCH_SDA 21 //4 
#define TOUCH_SCL 22 // 5 
#define TOUCH_INT 25 //2
#define TOUCH_RST 26 //13
