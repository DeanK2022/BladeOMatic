This is the BladeOMatic project which is to build a tester for epee, foil and sabre blades.  Plug your blade in to the machine, select the correct blade type and the tests will run automatically.
